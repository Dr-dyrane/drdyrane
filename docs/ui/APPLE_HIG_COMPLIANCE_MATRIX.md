...
| Menus | Secondary actions should remain contextual to current surface | `More` actions switch by active page (consult/history/pharmacy/scan) from a single tab-bar utility control | `src/components/layout/BottomNav.tsx` | Implemented |
