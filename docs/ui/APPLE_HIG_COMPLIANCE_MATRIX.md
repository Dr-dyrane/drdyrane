...
| Navigation | Tab bars should provide direct top-level destination switching | Bottom pill now exposes all core destinations directly (Consult, History, Pharmacy, Lab, Radiology) | `src/components/layout/BottomNav.tsx` | Implemented |
