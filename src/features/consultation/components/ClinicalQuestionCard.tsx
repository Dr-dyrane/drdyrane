...
export const ClinicalQuestionCard: React.FC<ClinicalQuestionCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="surface-raised rounded-[30px] px-5 py-6 shadow-glass h-[182px] sm:h-[198px] flex flex-col justify-center overflow-hidden"
    >
      {statement && (
      ...
      <h2
        aria-live="polite"
        className={`display-type ${questionSizeClass} font-medium tracking-tight text-content-primary text-center break-words hyphens-auto min-h-[88px] flex items-center justify-center`}
      >
        {typedQuestion}
